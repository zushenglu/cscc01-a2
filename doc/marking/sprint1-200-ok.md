...
## Planning Meetings (RPM.md, sprintN.md) (max 5 marks)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1 (whos working on what? capacity of team members?)
...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 8 / 10 (only 3 full standups)
...
## Tracking on JIRA  (max 20 marks) 
  ...
  - Is the pull request done by the person to whom the task has been assigned to?  (max 2 marks)
    ...
    Your Mark: 2 (Ticket 31 PR opened by someone else but most commits have been done by the assignee so I won't take marks off this time)
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1.5 (few PRs were squashed and merged with a decent commit message, but there were a few miscellaneous commits)
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 2.5 (everyone assigned a task but not completed)
...
## System Design (PDF or MD file or another suitable format) (max 10 marks)
  ...
  - Cover Page and Table of Contents (max 2 marks)
    ...
    Your Mark: 1 (cover page missing) 
...
## Sprint Demo (Max 14 marks) 
  ...
  - Documentation (max 2 marks)
    ...
    Your Mark: 1.5 (frontend docs, eg. add brief description of frontend components)
